...
|---|---|---|---|
| **Tier 1: The Anchor** | **The Pantry** | Raw Parquet | **Read-Only.** Constant and safe. |
| **Tier 2: The Branch** | **The Prep Station** | Cleaned/Formatted | **Reference.** Pre-chopped for the plot. |
...
## 3. The Comparison Theater: Your Studio

The theater provides a side-by-side view so you never lose your way.

### The Left Pane (The Map 🗺️)
- **Purpose**: Inspection and verification.
- **Toggle**: Switch between the **Raw ingredients (Tier 1)** and the **Prepped dish (Tier 2)**.
- **Rule**: This pane is **Locked**. You can explore and search here to find samples, but nothing you do here affects your plot. It's a safe "Sandbox."

### The Right Pane (The Canvas 🎨)
- **Purpose**: Active creation.
- **Format**: We default this to **Wide Format** because it's easier to read, but the plot handles the conversion behind the scenes.
- **Gated Reactivity**: To keep the dashboard fast, changes aren't applied instantly. You build your list of filters (the "Recipe"), then click **▶ Apply** to see the result.
