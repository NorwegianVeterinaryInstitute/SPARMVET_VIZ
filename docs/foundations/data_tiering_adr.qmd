...
- **Automated Freshness Check (ADR-024 Refinement)**: To prevent stale data issues, the system performs a **Manifest-to-Parquet Timestamp Comparison**. If the manifest (or any of its `!include` components in the mirrored logic directory) has been modified since the Parquet file was created, the Short-Circuit is automatically invalidated, and the pipeline re-runs in full.
