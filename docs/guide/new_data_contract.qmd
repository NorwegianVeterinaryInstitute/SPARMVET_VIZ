...
- Please read the chapter about [configuration files and data contract](../modules/configuration.qmd) in the architecture documentation before reading this chapter.
