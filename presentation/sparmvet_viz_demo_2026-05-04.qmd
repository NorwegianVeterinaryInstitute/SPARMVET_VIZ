...
**Phase 3** — port 8003 · Gallery · Blueprint · all features (developer)
:::
...
::: {.tier-label}
YAML manifest drives every layer. Each layer independently testable. **Shiny UI is kept as thin as possible** — no business logic above the Orchestrator.
:::
...
- Example: ADR-010 "Polars everywhere" — no Pandas until the final render step
